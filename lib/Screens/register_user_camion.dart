...
class _RegisterUserCamionState extends State<RegisterUserCamion> {
                                ...
                                onTap: () {
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) =>
                                          DialogSubirFoto(
                                            cameraFunction:
                                                _getImageCameraPlaca,
                                            galleryFunction:
                                                _getImageGalleryPlaca,
                                          ));
                                },
                                child: Container(
                                  height: 100.0,
                                  decoration: _imagePlaca == null
                                      ? BoxDecoration(
                                          borderRadius:
                                              BorderRadius.circular(15.0),
                                          color: Colors.white)
                                      : null,
                                  child: _imagePlaca == null
                                      ? Column(
                                          mainAxisAlignment:
                                ...
                                onTap: () {
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) =>
                                          DialogSubirFoto(
                                            cameraFunction:
                                                _getImageCameraLicencia,
                                            galleryFunction:
                                                _getImageGalleryLicencia,
                                          ));
                                },
                                child: Container(
                                  height: 100.0,
                                  decoration: _imageLicencia == null
                                      ? BoxDecoration(
                                          borderRadius:
                                              BorderRadius.circular(15.0),
                                          color: Colors.white)
                                      : null,
                                  child: _imageLicencia == null
                                      ? Column(
                                          mainAxisAlignment:
                                              MainAxisAlignment.center,
                                          children: [
                                      ...
                                      : ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(15.0),
                                          child: Image.file(_imageLicencia,
                                              fit: BoxFit.cover)),
                                ),
                              ),
                            ),
                                ...
                                onTap: () {
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) =>
                                          DialogSubirFoto(
                                            cameraFunction:
                                                _getImageCameraCamion,
                                            galleryFunction:
                                                _getImageGalleryCamion,
                                          ));
                                },
                                child: Container(
                                  height: 180.0,
                                  width: 280.0,
                                  decoration: _imageCamion == null
                                      ? BoxDecoration(
                                          borderRadius:
                                              BorderRadius.circular(10.0),
                                          color: Colors.white)
                                      : null,
                                  child: _imageCamion == null
                                      ? Column(
                                          mainAxisAlignment:
                                              MainAxisAlignment.center,
                                          children: [
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(_stateListRutasList[index]),
                      SizedBox(
                        height: 10.0,
                      ),
                      Container(
  ...
  _processCenserRegister() async {
    ...
    if (_NameConductor.length < 3) {
      Toast.show("Debes introducir un nombre válido", context,
          duration: Toast.LENGTH_LONG);
      return;
    }

    if (_image == null) {
      Toast.show("Por favor, necesita subir su foto para continuar", context,
    ...
    if (_Telefono != null && telefonoValido == false) {
      Toast.show(
          "El telefono debe tener 10 digitos y solo puede contener numeros",
          context,
          duration: Toast.LENGTH_LONG,
    ...
    if (_Email.length < 3) {
      Toast.show(
          "Debes introducir un email del centro de servicio válido", context,
          duration: Toast.LENGTH_LONG);
      return;
    }
    if (!_Email.contains("@")) {
    ...
    if (_Contrasena.length < 6) {
      ...
      if (_Contrasena != _ConfirmarContrasena) {
        Toast.show("Sus contraseñas no coinciden", context,
            duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
        return;
      }
    }
    ...
    if (_NumUnidad.isEmpty) {
      Toast.show("El numero de unidad del camion no puede estar vacio", context,
          duration: Toast.LENGTH_LONG);
      return;
    }
    if (numeroUnidadValido == false) {
      Toast.show("Solo debe contener Numeros", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    if (_Placa.isEmpty) {
    ...
    if (_imagePlaca == null) {
      Toast.show("Por favor, necesita subir la foto de la placa para continuar",
          context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    if (_imageLicencia == null) {
      Toast.show(
          "Por favor, necesita subir la foto de su licencia para continuar",
          context,
          duration: Toast.LENGTH_LONG,
          gravity: Toast.BOTTOM);
      return;
    ...
    if (_imageCamion == null) {
      Toast.show(
          "Por favor, necesita subir la foto de su camion para continuar",
          context,
          duration: Toast.LENGTH_LONG,
          gravity: Toast.BOTTOM);
      return;
    ...
    if (_horarioRutas.length < 3) {
      Toast.show(
          "Debes introducir el horario de la ruta correctamente", context,
          duration: Toast.LENGTH_LONG);
      return;
    }
    ...
    var auth =
        await Authentication().createUser(email: _Email, password: _Contrasena);
    ...
    if (auth.succes) {
      ...
      if (user != null) {
        ...
        final Reference storageRef = FirebaseStorage.instance
            .ref()
            .child(FirebaseReferencias.REFERENCE_CENSERS)
            .child("Perfil" + "-perfil-1" + id_variable);
        ...
        final TaskSnapshot downloadUrl =
            (await uploadTaske.whenComplete(() => null));
        final String urls = (await downloadUrl.ref.getDownloadURL());
        //////////
        final Reference storageRefPlaca = FirebaseStorage.instance
            .ref()
            .child(FirebaseReferencias.REFERENCE_Placa)
            .child("PLaca" + "-perfil-1" + id_variable);
        ...
        final TaskSnapshot downloadUrlPlaca =
            (await uploadTaskePlca.whenComplete(() => null));
        final String urlsPlaca = (await downloadUrlPlaca.ref.getDownloadURL());
        /////////////////////////
        final Reference storageRefLicencia = FirebaseStorage.instance
            .ref()
            .child(FirebaseReferencias.REFERENCE_Licencia)
            .child("Licencia" + "-perfil-1" + id_variable);
        ...
        final TaskSnapshot downloadUrlLicencia =
            (await uploadTaskeLicencia.whenComplete(() => null));
        final String urlsLicencia =
            (await downloadUrlLicencia.ref.getDownloadURL());
        //////////////////////////////////

        final Reference storageRefCamion = FirebaseStorage.instance
            .ref()
            .child(FirebaseReferencias.REFERENCE_Camion)
            .child("Camion" + "-perfil-1" + id_variable);
        ...
        final TaskSnapshot downloadUrlCamion =
            (await uploadTaskeCamion.whenComplete(() => null));
        final String urlsCamion =
            (await downloadUrlCamion.ref.getDownloadURL());

        // int numeroDeActVacion=12;
        //  QuerysService().SaveCenser(idCenser: user.uid, errorFunction: _cancelSpinnerError, function: _cancelSpinnerSuccesful(user.uid), context: context, collectionValues: CenserModel().toJsonBodyCamio(
        //     user.uid,
        //    _NameConductor,
        //     _Email,
        //     now,
        ...
        bool errorGuardarCamioner = await QuerysService().SaveCamionero(
            reference: FirebaseReferencias.REFERENCE_CENSERS,
            id: user.uid,
            collectionValues: CenserModel().toJsonBodyCamio(
              user.uid,
              _NameConductor,
              _Email,
              now,
        ...
        if (errorGuardarCamioner) {
          ...
          _cancelSpinnerSuccesful(user.uid);
          Toast.show("¡Se ha registado con exito!", context,
              duration: Toast.LENGTH_LONG);
        }
      ...
      Toast.show(
          "Ha ocurrido un problema, Verifique su correo electronico", context,
          duration: Toast.LENGTH_LONG);
      _cancelSpinnerError();
    }
  }
